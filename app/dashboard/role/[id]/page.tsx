...
import { getRoleDetail } from "@/app/api/role"; // Assuming API function is in this file
import { RoleDetailResponse } from "@/interface/role"; // Assuming RoleDetailResponse is in this interface file
...
const RoleDetail: React.FC = () => {
  ...
  return (
    <div className="container mx-auto p-6">
      <BackButton previousPathname="/dashboard/role" /> {/* You can update this path as needed */}
      ...
      {roleDetail && (
        <>
          <div className="bg-white shadow-lg rounded-lg p-6 mb-6">
            <h2 className="text-2xl font-medium text-gray-900 mb-4">Role: {roleDetail.name}</h2>
